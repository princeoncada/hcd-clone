    ...
    return (
        <div className="text-center mt-10">
            <div className="bg-blue-950 text-white p-5 py-10">
                <div className="pb-5 text-red-500 font-bold text-4xl">
                    Preamble
                </div>
                <div className="text-justify md:text-center md:text-lg lg:w-2/5 lg:mx-auto">
            ...
            <div className="bg-red-500 text-white p-5 py-10">
                <div className="pb-5 text-blue-950 font-bold text-4xl">
                    Vision & Mission
                </div>
